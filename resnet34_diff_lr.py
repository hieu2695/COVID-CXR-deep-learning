...
#loss, rate = learning_rate_finder(model, criterion, min_lr=1e-7, max_lr = 1e-3, iteration = 300, trainloader=trainloader)
...
{ 'params': model.layer1.parameters(), 'lr': LR/ 7},
{ 'params': model.layer2.parameters(), 'lr': LR/ 7},
